 ...
 * are represented in seconds. Currently there are 6 states for a device: "up",
 * "resuming", "suspended", and "down". "down" means the device is not
